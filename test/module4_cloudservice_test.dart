...
void main() {
  ...
  group('Module 4 - Cloud Service (LogModel + FakeMongoService)', () {
    ...
    test('TC01: toMap should return Map with all required keys', () {
      ...
      expect(result['title'], 'Test Log', reason: 'Nilai title harus sesuai');
    });
    ...
    test('TC02: fromMap should create LogModel with correct field values', () {
      ...
      expect(result.category, 'Software', reason: 'Category harus Software');
    });

    // TC03 ──────────────────────────────────────────────────
    test(
      'TC03: toMap then fromMap round-trip should produce identical data',
      () {
        // (1) Arrange
    ...
    // TC04 ──────────────────────────────────────────────────
    test(
      'TC04: insertLog then getLogs should return list with 1 item',
      () async {
        // (1) Arrange
        ...
        // (3) Assert
        expect(actual, expected, reason: 'Expected $expected but got $actual');
        expect(result[0].title, 'Test Log', reason: 'Title harus sesuai');
      },
    );
    ...
    // TC06 ──────────────────────────────────────────────────
    test(
      'TC06: inserting two logs should make getLogs return length 2',
      () async {
        // (1) Arrange
        final fake = FakeMongoService();
    ...
    // TC08 ──────────────────────────────────────────────────
    test(
      'TC08: updateLog should throw Exception when log id is null',
      () async {
        // (1) Arrange
        final fake = FakeMongoService();
    ...
    // TC09 ──────────────────────────────────────────────────
    test(
      'TC09: getLogs should return empty list when storage is empty',
      () async {
        // (1) Arrange
